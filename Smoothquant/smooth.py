...
from OPT_LN import OPT_LayerNorm
...
@torch.no_grad()
def smooth_lm(model, scales, activation_para):
    for name, module in model.named_modules():
        if isinstance(module, OPTDecoderLayer):
            ...
            module.self_attn_layer_norm = OPT_LayerNorm.from_float(module.self_attn_layer_norm, qkv_input_scales,
                                                             activation_para)
            fc1 = module.fc1
            ...
            module.final_layer_norm = OPT_LayerNorm.from_float(module.final_layer_norm, fc1_input_scales,
                                                             activation_para)
